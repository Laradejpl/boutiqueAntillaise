...
class __TwigTemplate_ea768888c6ac01ba00b669acb62463b8f1904bae913563e46d7da3618b9eeaba extends Template
{
    private $source;
    private $macros = [];
...
ALTER TABLE `product`
  ADD CONSTRAINT `FK_D34A04AD12469DE2` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`);";
    ...
    {
        return new Source("", "sql/lbantillaise.sql", "/Users/test/Downloads/laboutiqueFrancaise/templates/sql/lbantillaise.sql");
    }
}
